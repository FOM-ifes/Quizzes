...
Säulendiagramm und Histogramm sind Grafiken i.$\,$d.$\,$R. für eine kategoriale (Säulendiagramm) oder eine metrische Variable (Histogramm). Sie können ggf. gruppiert werden nach einer weiteren kategorialen Variable.
