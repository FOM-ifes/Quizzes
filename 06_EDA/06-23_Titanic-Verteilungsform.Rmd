...
```{r, results="hide", fig.height = 4, fig.width = 4.6, out.width = "50%", fig.cap = "", warning=FALSE, message=FALSE}
...
Answerlist
----------
* Falsch, der Median der Daten liegt bei `r qdata(~ age, data = titanic, p = 0.5)` (in der Abbildung nur geschätzt, 50 % der Daten liegen vor, 50 % der Daten liegen hinter dem Median), was hier aber nicht (näherungsweise) die Mitte auf der x-Achse ist.
