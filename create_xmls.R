...
Quizzes <- list(
  ...
  Wdh_GLWiss_1 = c(
    ...
    #     "02_Grundlagen-Wissenschaft/02-12_Hypothese.Rmd",    # Streichen in QD neu/SM  
  ...
  # Lineare Regression: Inferenz - Anwendung
  Wdh_LinReg_3c = c(
  ...
  Wdh_Kausal_1 = c(
    "10_Kausal/10-11_Counterfactual.Rmd",
  ...
  # Random Forest
  Wdh_RF = c(
    "16_RandomForest/16-11_Entscheidungsbaum.Rmd", 
  ...
  # Cluster
  Wdh_Cluster = c(
    "15_cluster/15-11_Ziel-kmeans.Rmd",
    "15_cluster/15-12_WCSS-Definition.Rmd",
    "15_cluster/15-13_WCSS-Wert.Rmd"
  ),
  ...
  Wdh_Offen_2 = c(
    "11_Offene-Fragen/11-21_Konfidenzintervall.Rmd",
  ...
  Wdh_Offen_3 = c(
    "11_Offene-Fragen/11-31_Regression.Rmd",
    "11_Offene-Fragen/11-32_HKA.Rmd"
  ),
  
  # offene Frage Kausale Leiter
  Wdh_Offen_4 = c(
    "11_Offene-Fragen/11-41_Kausale-Leiter.Rmd"
  ),
  
  # offene Fragen Regression und Inferenz
  Wdh_Offen_5 = c(
    "11_Offene-Fragen/11-21_Konfidenzintervall.Rmd",
    "11_Offene-Fragen/11-22_Inferenz.Rmd",
    "11_Offene-Fragen/11-31_Regression.Rmd"
