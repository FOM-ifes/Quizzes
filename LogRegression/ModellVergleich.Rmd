...
Es soll zwei logistische Regressionsmodelle mit der Getriebeart `am` als abhängige Variable ($y$) und unterschiedlichen unabhängigen Variablen ($x_k$) verglichen werden.
