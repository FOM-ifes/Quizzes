...
Der Koeffizient für `alter` ist positiv, d.$\,$h., mit zunehmenden Alter steigen im Modell der Stichprobe im Mittel die Ausgaben.
...
Wenn das Ergebnis für keinen Zusammenhang zwischen Geschlecht und Alter mit den Ausgaben sprechen würde, wären die p-Wert (Spalte `Pr(>|t|)`) groß. Hier sind sie sehr klein, was gegen die Nullhypothese (keine Zusammenhang) spricht und damit indirekt für einen Zusammenhang (Alternativhypothese).
