...
Darüber hinaus sind die p-Werte (Spalte `Pr(>|t|)`) für beide Variablen klein. Die Daten sind damit nicht kompatibel zu den Nullhypothesen $\beta_{alter}=0$ und $\beta_{geschlechtw}=0$.
