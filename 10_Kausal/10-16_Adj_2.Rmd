...
- Chain (Kette) $X\rightarrow Z\rightarrow Y$: Für den *Mediator* $Z$ darf nicht adjustiert werden, da dann der totale Effekt in einen *direkten* Effekt und einen *indirekten* Effekt via $Z$ zerlegt wird.
