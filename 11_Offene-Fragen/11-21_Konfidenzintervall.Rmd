...
- In der Stichprobe ergenen sich $\hat{\mu}_{\text{neutral}} = `r round(mn[1],2)`$ und $\hat{\mu}_{\text{lächeln}} = `r round(mn[2],2)`$ und damit eine Differenz von $\bar{y}_{\text{lächeln}} - \bar{y}_{\text{neutral}}=`r round(dmn,3)`$.
