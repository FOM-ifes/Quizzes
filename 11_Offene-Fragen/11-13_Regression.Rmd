...
Im Modell der Stichprobe wird c.$\,$p. im Mittelwert ein um $`r round(coef(erglm)[3],2)`$ bessere Bewertung beobachtet, wenn ein um eine Einheit besseres Aussehen beobachtet wird. 
...
Die Nullhypothesen, es gibt keinen Zusammenhang, d. h., $H_0: \beta_{\text{male}}=0$ und  $H_0: \beta_{\text{beauty}}=0$ werden beide mit p-Werten $<0.05$ zum Niveau $\alpha=5\%$ verworfen, d. h., es wird auf einen statistisch erkennbaren Zusammenhang geschlossen.
