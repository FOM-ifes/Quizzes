...
Die Hauptkomponentenanalyse erfolgt unter Varimax-Rotation. Die Hauptkomponenten erklären `r varhka(wine)[3] * 100` % der Varianz. Sechs Variablen laden deutlich auf die erste Hauptkomponente, vier auf die zweite und zwei auf die dritte.
