...
- `h.hausfall`: Ist in der Vergangenheit schon einmal eine Zahlung ausgefallen (`ja`, `nein`)?
...
Bei welcher Ausprägung der Variable `h.hausfall` ist der modellierte Zinssatz höher?
