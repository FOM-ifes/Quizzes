...
Die Simualtion von Stichproben, in denen es nach Konstruktion keinen Zusammenhang zwischen `mpg` und `wt` gibt, ergibt folgendes Ergebnis:
...
gf_histogram( ~ wt, data = Nullvtlg, center = 0, nbins = 21) %>%
...
Meta-information
================
exname: Simualtion Nullhypothese
extype: schoice
exsolution: 01